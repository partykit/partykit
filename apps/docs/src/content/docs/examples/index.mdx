...
Are you using PartyKit? We want to hear from you! Reach out on [Discord](https://discord.gg/KDZb7J4uxJ) or [Twitter](https://twitter.com/partykit_io)!
:::

## Next.js chat app with user avatars, AI agents, and auth

![chat app](/src/assets/chat-app.png)
...
![cursors](/src/assets/voronoi.png)
...
![text editor](/src/assets/text-editor.gif)
...
![live polls](/src/assets/poll.gif)
...
![youtube watch party](/src/assets/youtube-watch-party.png)
...
![mosaic game](/src/assets/mosaic.png)
